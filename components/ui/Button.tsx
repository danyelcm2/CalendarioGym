...
const variants: Record<ButtonVariant, string> = {
  ...
  secondary:
    "border border-[#d7ded7] bg-white text-[#17201a] hover:bg-[#f3f6f2] focus-visible:outline-[#4f8f7c] dark:border-[#31445f] dark:bg-[#172033] dark:text-[#f8fbff] dark:hover:bg-[#22314a]",
  ghost:
    "text-[#4d5b50] hover:bg-[#eef3ef] focus-visible:outline-[#4f8f7c] dark:text-[#dbe7f6] dark:hover:bg-[#22314a]",
  danger:
